...
This produces a cleaned, long-form ('tidy') dataset, as shown in the below sample:
...
See the `output/deaths_qld_australia.html` html report generated from the `R/report.Rmd` markdown document.
